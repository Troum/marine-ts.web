      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div class="max-w-3xl">
          ...
          <h1 class="font-display text-4xl lg:text-5xl text-mts-text leading-tight mb-6">
            Последние <span class="text-mts-accent">новости</span> компании
          </h1>
          <div class="w-12 h-0.5 bg-mts-accent mb-6" />
          <p class="font-body text-lg text-mts-text-secondary leading-relaxed">
            Следите за развитием компании, новыми проектами и достижениями в сфере судоремонта.
          </p>
        </div>
      </div>
    </section>
      ...
      <section v-if="featuredNews" class="relative py-16 overflow-hidden bg-white">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div class="bg-mts-bg border border-mts-border p-8 lg:p-12">
            ...
            <NuxtLink :to="`/news/${featuredNews.slug}`" class="btn-primary mb-6 inline-flex"> Читать полностью </NuxtLink>
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <h3 class="font-display text-lg text-mts-text mb-3">
                <NuxtLink :to="`/news/${item.slug}`" class="hover:text-mts-accent transition-colors">
                  {{ item.title }}
                </NuxtLink>
              </h3>
